...
$('.project-close').click(function () {
    ...
    $('html, body').animate({
        scrollTop: $('#details').offset().top - 76
    }, 600);
...
function initialize() {
  	var mapOptions = {
    	zoom: 12,
    	center: new google.maps.LatLng(39.143156,-76.599266),
    	scrollwheel: false,
  	...
  	var myLatLng = new google.maps.LatLng(39.143156,-76.599266);
  	var image = 'images/google-maps/pin.png';

  	var contentString = '<h3>Calvary Summer Session</h3>' +
  	'<p>407 Marley Station Road, Glen Burnie, MD 21060</p>';
